...
\begin{minipage}[t]{0.33\textwidth} % The right column takes up 66% of the text width of the page
  ...
  \location{Most used:}
  \textbullet{} Python {\footnotesize \textit{\textbf{(esp. PANDAS)}}} \textbullet{} C  \textbullet{} C\# \\
  ...
  \textbullet{} C++ \textbullet{} ARKit \textbullet{} ARToolKit \\
  ...
  \location{Languages:}
  English {\footnotesize \textit{\textbf{(Native)}}} \textbullet{} German {\footnotesize \textit{\textbf{(B1)}}} \\
