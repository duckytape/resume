...
May this little box disrupt the repetitive nature of resume reading. \\
This box isn't meant to sway you, but I figure you probably have to read a few of these, so thank you for your time and reading my resume! :)
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
\item Worked with one other organiser to coordinate promotion, scheduling and other on the day tasks.
\item Requested and reviewed presentations, while working with accepted speakers to polish presentations and make sure they could logistically attend.
