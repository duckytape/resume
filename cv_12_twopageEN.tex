...
%\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Vance}}}}}
  \runsubsection{1\&1 Telecommuncations SE}
  ...
  %\end{tightitemize}
  \\ Main tech used: \textbullet{} Angular {\footnotesize \textit{\textbf{(typescript, jasmine, cypress)}}} \textbullet{} HTML5 \textbullet{} SCSS \textbullet{}{\footnotesize \textit{\textbf{(Jenkins, Groovy)}}}
...
%----------------------------------------------------------------------------------------
%
\begin{minipage}[t]{0.25\textwidth} % The right column takes up 66% of the text width of the page
...
%  \sectionspace % Some whitespace after the section
  ...
  \textbullet{} CSS/SCSS %\textbullet{} Cypress
  ...
  \textbullet{} Game Design \textbullet{} Enthusiasm\\
   %\textbullet{} Customer Service \\ %\textbullet{} Team Work \\
  %\textbullet{} Sailing
...
\begin{minipage}[t]{0.25\textwidth} % The right column takes up 66% of the text width of the page
  ...
  Tasjam & Founder \\
  TUCS & President \\
  linux.conf.au & Organiser \\ %Conference/ Minconf
  CompCon & CoFounder \\
  Startup Tas & Committee \\
  %Girl Geek Coffees & Ambassador \\
  %ACS & Committee/ YiTtas Chair \\
